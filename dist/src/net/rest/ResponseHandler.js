...
export var ResponseHandler = {
    ...
    handleWebCommonFailure: function (response) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(response.resultCode === ResponseCode.ACCESS_TOKEN_EXPIRED)) return [3 /*break*/, 2];
                    return [4 /*yield*/, RequestHandler.handleWebAccessTokenExpire()];
